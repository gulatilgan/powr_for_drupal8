...
CKEDITOR.plugins.add( 'powrmicroblog', {
  icons: 'microblog',
  init: function( editor ) {
    editor.ui.addButton( 'powr_microblog', {
      label: 'Insert POWr Microblog',
      command: 'insertpowrmicroblog',
      toolbar: 'insert',
      icon: 'microblog'
    });
    editor.addCommand("insertpowrmicroblog", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'microblog');
      }
    });
