...
CKEDITOR.plugins.add( 'powrpoll', {
  icons: 'poll',
  init: function( editor ) {
    editor.ui.addButton( 'powr_poll', {
      label: 'Insert POWr Poll',
      command: 'insertpowrpoll',
      toolbar: 'insert',
      icon: 'poll'
    });
    editor.addCommand("insertpowrpoll", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'poll');
      }
    });
