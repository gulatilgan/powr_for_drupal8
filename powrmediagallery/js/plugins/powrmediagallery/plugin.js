...
CKEDITOR.plugins.add( 'powrmediagallery', {
  icons: 'mediagallery',
  init: function( editor ) {
    editor.ui.addButton( 'powr_mediagallery', {
      label: 'Insert POWr Media Gallery',
      command: 'insertpowrmediagallery',
      toolbar: 'insert',
      icon: 'mediagallery'
    });
    editor.addCommand("insertpowrmediagallery", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'media-gallery');
      }
    });
