...
CKEDITOR.plugins.add( 'powrmailinglist', {
  icons: 'mailinglist',
  init: function( editor ) {
    editor.ui.addButton( 'powr_mailinglist', {
      label: 'Insert POWr Mailing List',
      command: 'insertpowrmailinglist',
      toolbar: 'insert',
      icon: 'mailinglist'
    });
    editor.addCommand("insertpowrmailinglist", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'mailing-list');
      }
    });
