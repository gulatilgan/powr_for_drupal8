...
CKEDITOR.plugins.add( 'powrholidaycountdown', {
  icons: 'holidaycountdown',
  init: function( editor ) {
    editor.ui.addButton( 'powr_holidaycountdown', {
      label: 'Insert POWr Holiday Countdown',
      command: 'insertpowrholidaycountdown',
      toolbar: 'insert',
      icon: 'holidaycountdown'
    });
    editor.addCommand("insertpowrholidaycountdown", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'holiday-countdown');
      }
    });
