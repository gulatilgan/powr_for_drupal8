...
CKEDITOR.plugins.add( 'powrgraph', {
  icons: 'graph',
  init: function( editor ) {
    editor.ui.addButton( 'powr_graph', {
      label: 'Insert POWr Graph',
      command: 'insertpowrgraph',
      toolbar: 'insert',
      icon: 'graph'
    });
    editor.addCommand("insertpowrgraph", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'graph');
      }
    });
