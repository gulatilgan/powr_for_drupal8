...
CKEDITOR.plugins.add( 'powrvideogallery', {
  icons: 'videogallery',
  init: function( editor ) {
    editor.ui.addButton( 'powr_videogallery', {
      label: 'Insert POWr Video Gallery',
      command: 'insertpowrvideogallery',
      toolbar: 'insert',
      icon: 'videogallery'
    });
    editor.addCommand("insertpowrvideogallery", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'video-gallery');
      }
    });
