...
CKEDITOR.plugins.add( 'powrbannerslider', {
  icons: 'bannerslider',
  init: function( editor ) {
    editor.ui.addButton( 'powr_bannerslider', {
      label: 'Insert POWr Banner Slider',
      command: 'insertpowrbannerslider',
      toolbar: 'insert',
      icon: 'bannerslider'
    });
    editor.addCommand("insertpowrbannerslider", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'banner-slider');
      }
    });
