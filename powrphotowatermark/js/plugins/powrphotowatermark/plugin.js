...
CKEDITOR.plugins.add( 'powrphotowatermark', {
  icons: 'photowatermark',
  init: function( editor ) {
    editor.ui.addButton( 'powr_photowatermark', {
      label: 'Insert POWr Photo Watermark',
      command: 'insertpowrphotowatermark',
      toolbar: 'insert',
      icon: 'photowatermark'
    });
    editor.addCommand("insertpowrphotowatermark", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'photo-watermark');
      }
    });
