...
CKEDITOR.plugins.add( 'powrbrowsernotification', {
  icons: 'browsernotification',
  init: function( editor ) {
    editor.ui.addButton( 'powr_browsernotification', {
      label: 'Insert POWr Browser Notification',
      command: 'insertpowrbrowsernotification',
      toolbar: 'insert',
      icon: 'browsernotification'
    });
    editor.addCommand("insertpowrbrowsernotification", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'browser-notification');
      }
    });
