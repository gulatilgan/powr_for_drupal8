...
CKEDITOR.plugins.add( 'powrbutton', {
  icons: 'button',
  init: function( editor ) {
    editor.ui.addButton( 'powr_button', {
      label: 'Insert POWr Button',
      command: 'insertpowrbutton',
      toolbar: 'insert',
      icon: 'button'
    });
    editor.addCommand("insertpowrbutton", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'button');
      }
    });
