...
CKEDITOR.plugins.add( 'powrpack', {
  icons: 'pack',
  init: function( editor ) {
    editor.ui.addButton( 'powr_pack', {
      label: 'Insert POWr Pack',
      command: 'insertpowrpack',
      toolbar: 'insert',
      icon: 'pack'
    });
    editor.addCommand("insertpowrpack", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'pack');
      }
    });
