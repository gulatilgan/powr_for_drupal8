...
CKEDITOR.plugins.add( 'powrtumblrfeed', {
  icons: 'tumblrfeed',
  init: function( editor ) {
    editor.ui.addButton( 'powr_tumblrfeed', {
      label: 'Insert POWr Tumblr Feed',
      command: 'insertpowrtumblrfeed',
      toolbar: 'insert',
      icon: 'tumblrfeed'
    });
    editor.addCommand("insertpowrtumblrfeed", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'tumblr-feed');
      }
    });
