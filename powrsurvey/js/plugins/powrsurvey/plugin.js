...
CKEDITOR.plugins.add( 'powrsurvey', {
  icons: 'survey',
  init: function( editor ) {
    editor.ui.addButton( 'powr_survey', {
      label: 'Insert POWr Survey',
      command: 'insertpowrsurvey',
      toolbar: 'insert',
      icon: 'survey'
    });
    editor.addCommand("insertpowrsurvey", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'survey');
      }
    });
