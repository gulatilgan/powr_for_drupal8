...
CKEDITOR.plugins.add( 'powrcontactform', {
  icons: 'contactform',
  init: function( editor ) {
    editor.ui.addButton( 'powr_contactform', {
      label: 'Insert POWr Contact Form',
      command: 'insertpowrcontactform',
      toolbar: 'insert',
      icon: 'contactform'
    });
    editor.addCommand("insertpowrcontactform", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'contact-form');
      }
    });
