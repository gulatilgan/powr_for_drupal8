...
CKEDITOR.plugins.add( 'powrresume', {
  icons: 'resume',
  init: function( editor ) {
    editor.ui.addButton( 'powr_resume', {
      label: 'Insert POWr Resume',
      command: 'insertpowrresume',
      toolbar: 'insert',
      icon: 'resume'
    });
    editor.addCommand("insertpowrresume", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'resume');
      }
    });
