...
CKEDITOR.plugins.add( 'powremaillistsignup', {
  icons: 'emaillistsignup',
  init: function( editor ) {
    editor.ui.addButton( 'powr_emaillistsignup', {
      label: 'Insert POWr Email List Signup',
      command: 'insertpowremaillistsignup',
      toolbar: 'insert',
      icon: 'emaillistsignup'
    });
    editor.addCommand("insertpowremaillistsignup", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'email-list-signup');
      }
    });
