...
CKEDITOR.plugins.add( 'powrphotoeditor', {
  icons: 'photoeditor',
  init: function( editor ) {
    editor.ui.addButton( 'powr_photoeditor', {
      label: 'Insert POWr Photo Editor',
      command: 'insertpowrphotoeditor',
      toolbar: 'insert',
      icon: 'photoeditor'
    });
    editor.addCommand("insertpowrphotoeditor", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'photo-editor');
      }
    });
