...
CKEDITOR.plugins.add( 'powrmap', {
  icons: 'map',
  init: function( editor ) {
    editor.ui.addButton( 'powr_map', {
      label: 'Insert POWr Map',
      command: 'insertpowrmap',
      toolbar: 'insert',
      icon: 'map'
    });
    editor.addCommand("insertpowrmap", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'map');
      }
    });
