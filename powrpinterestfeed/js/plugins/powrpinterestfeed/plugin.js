...
CKEDITOR.plugins.add( 'powrpinterestfeed', {
  icons: 'pinterestfeed',
  init: function( editor ) {
    editor.ui.addButton( 'powr_pinterestfeed', {
      label: 'Insert POWr Pinterest Feed',
      command: 'insertpowrpinterestfeed',
      toolbar: 'insert',
      icon: 'pinterestfeed'
    });
    editor.addCommand("insertpowrpinterestfeed", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'pinterest-feed');
      }
    });
