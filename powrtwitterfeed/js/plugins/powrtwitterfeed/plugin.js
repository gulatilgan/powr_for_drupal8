...
CKEDITOR.plugins.add( 'powrtwitterfeed', {
  icons: 'twitterfeed',
  init: function( editor ) {
    editor.ui.addButton( 'powr_twitterfeed', {
      label: 'Insert POWr Twitter Feed',
      command: 'insertpowrtwitterfeed',
      toolbar: 'insert',
      icon: 'twitterfeed'
    });
    editor.addCommand("insertpowrtwitterfeed", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'twitter-feed');
      }
    });
