...
CKEDITOR.plugins.add( 'powrrssfeed', {
  icons: 'rssfeed',
  init: function( editor ) {
    editor.ui.addButton( 'powr_rssfeed', {
      label: 'Insert POWr RSS Feed',
      command: 'insertpowrrssfeed',
      toolbar: 'insert',
      icon: 'rssfeed'
    });
    editor.addCommand("insertpowrrssfeed", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'rss-feed');
      }
    });
