...
CKEDITOR.plugins.add( 'powrrecommendedproducts', {
  icons: 'recommendedproducts',
  init: function( editor ) {
    editor.ui.addButton( 'powr_recommendedproducts', {
      label: 'Insert POWr Recommended Products',
      command: 'insertpowrrecommendedproducts',
      toolbar: 'insert',
      icon: 'recommendedproducts'
    });
    editor.addCommand("insertpowrrecommendedproducts", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'recommended-products');
      }
    });
