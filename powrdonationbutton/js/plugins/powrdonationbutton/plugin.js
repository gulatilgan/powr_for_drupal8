...
CKEDITOR.plugins.add( 'powrdonationbutton', {
  icons: 'donationbutton',
  init: function( editor ) {
    editor.ui.addButton( 'powr_donationbutton', {
      label: 'Insert POWr Donation Button',
      command: 'insertpowrdonationbutton',
      toolbar: 'insert',
      icon: 'donationbutton'
    });
    editor.addCommand("insertpowrdonationbutton", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'donation-button');
      }
    });
