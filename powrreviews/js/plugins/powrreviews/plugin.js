...
CKEDITOR.plugins.add( 'powrreviews', {
  icons: 'reviews',
  init: function( editor ) {
    editor.ui.addButton( 'powr_reviews', {
      label: 'Insert POWr Reviews',
      command: 'insertpowrreviews',
      toolbar: 'insert',
      icon: 'reviews'
    });
    editor.addCommand("insertpowrreviews", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'reviews');
      }
    });
