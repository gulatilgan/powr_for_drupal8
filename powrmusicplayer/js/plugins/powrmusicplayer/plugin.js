...
CKEDITOR.plugins.add( 'powrmusicplayer', {
  icons: 'musicplayer',
  init: function( editor ) {
    editor.ui.addButton( 'powr_musicplayer', {
      label: 'Insert POWr Music Player',
      command: 'insertpowrmusicplayer',
      toolbar: 'insert',
      icon: 'musicplayer'
    });
    editor.addCommand("insertpowrmusicplayer", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'music-player');
      }
    });
