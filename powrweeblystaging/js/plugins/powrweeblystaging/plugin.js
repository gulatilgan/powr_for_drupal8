...
CKEDITOR.plugins.add( 'powrweeblystaging', {
  icons: 'weeblystaging',
  init: function( editor ) {
    editor.ui.addButton( 'powr_weeblystaging', {
      label: 'Insert POWr Weebly Staging',
      command: 'insertpowrweeblystaging',
      toolbar: 'insert',
      icon: 'weeblystaging'
    });
    editor.addCommand("insertpowrweeblystaging", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'weebly-staging');
      }
    });
