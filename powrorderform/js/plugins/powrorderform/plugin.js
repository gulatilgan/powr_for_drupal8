...
CKEDITOR.plugins.add( 'powrorderform', {
  icons: 'orderform',
  init: function( editor ) {
    editor.ui.addButton( 'powr_orderform', {
      label: 'Insert POWr Order Form',
      command: 'insertpowrorderform',
      toolbar: 'insert',
      icon: 'orderform'
    });
    editor.addCommand("insertpowrorderform", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'order-form');
      }
    });
