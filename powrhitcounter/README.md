# 🎉 Welcome to Hit Counter for Drupal 8 🎉

### Easily add a full-featured customizable Hit Counter to any Drupal 8 Article or Page.

## How to install the POWr Hit Counter Module:
<ol>
  <li><a href="https://cdn.jsdelivr.net/gh/superpowr/powr_for_drupal8/powrhitcounter.zip">Download POWr Hit Counter Drupal 8 Extension</a></li>
  ...
  <li> When the Module is successfully installed, click <b>Enable newly added modules.</b> Find the new module (search for "POWr"), select the checkbox next to POWr Hit Counter and click the blue <b>Install</b></li>
</ol>

## How to configure POWr Hit Counter Module:
...
## How to add a POWr Hit Counter to an Article or Page
<ol>
