...
CKEDITOR.plugins.add( 'powrhitcounter', {
  icons: 'hitcounter',
  init: function( editor ) {
    editor.ui.addButton( 'powr_hitcounter', {
      label: 'Insert POWr Hit Counter',
      command: 'insertpowrhitcounter',
      toolbar: 'insert',
      icon: 'hitcounter'
    });
    editor.addCommand("insertpowrhitcounter", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'hit-counter');
      }
    });
