...
CKEDITOR.plugins.add( 'powryahoolocal', {
  icons: 'yahoolocal',
  init: function( editor ) {
    editor.ui.addButton( 'powr_yahoolocal', {
      label: 'Insert POWr Yahoo Local',
      command: 'insertpowryahoolocal',
      toolbar: 'insert',
      icon: 'yahoolocal'
    });
    editor.addCommand("insertpowryahoolocal", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'yahoo-local');
      }
    });
