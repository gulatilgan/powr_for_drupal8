...
CKEDITOR.plugins.add( 'powrfacebookfeed', {
  icons: 'facebookfeed',
  init: function( editor ) {
    editor.ui.addButton( 'powr_facebookfeed', {
      label: 'Insert POWr Facebook Feed',
      command: 'insertpowrfacebookfeed',
      toolbar: 'insert',
      icon: 'facebookfeed'
    });
    editor.addCommand("insertpowrfacebookfeed", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'facebook-feed');
      }
    });
