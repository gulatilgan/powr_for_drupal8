...
CKEDITOR.plugins.add( 'powrwixlocal', {
  icons: 'wixlocal',
  init: function( editor ) {
    editor.ui.addButton( 'powr_wixlocal', {
      label: 'Insert POWr Wix Local',
      command: 'insertpowrwixlocal',
      toolbar: 'insert',
      icon: 'wixlocal'
    });
    editor.addCommand("insertpowrwixlocal", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'wix-local');
      }
    });
