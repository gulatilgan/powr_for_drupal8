...
CKEDITOR.plugins.add( 'powraboutus', {
  icons: 'aboutus',
  init: function( editor ) {
    editor.ui.addButton( 'powr_aboutus', {
      label: 'Insert POWr About Us',
      command: 'insertpowraboutus',
      toolbar: 'insert',
      icon: 'aboutus'
    });
    editor.addCommand("insertpowraboutus", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'about-us');
      }
    });
