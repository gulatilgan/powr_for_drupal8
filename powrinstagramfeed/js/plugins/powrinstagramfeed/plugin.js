...
CKEDITOR.plugins.add( 'powrinstagramfeed', {
  icons: 'instagramfeed',
  init: function( editor ) {
    editor.ui.addButton( 'powr_instagramfeed', {
      label: 'Insert POWr Instagram Feed',
      command: 'insertpowrinstagramfeed',
      toolbar: 'insert',
      icon: 'instagramfeed'
    });
    editor.addCommand("insertpowrinstagramfeed", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'instagram-feed');
      }
    });
