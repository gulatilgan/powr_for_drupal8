...
CKEDITOR.plugins.add( 'powrphotogallery', {
  icons: 'photogallery',
  init: function( editor ) {
    editor.ui.addButton( 'powr_photogallery', {
      label: 'Insert POWr Photo Gallery',
      command: 'insertpowrphotogallery',
      toolbar: 'insert',
      icon: 'photogallery'
    });
    editor.addCommand("insertpowrphotogallery", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'photo-gallery');
      }
    });
