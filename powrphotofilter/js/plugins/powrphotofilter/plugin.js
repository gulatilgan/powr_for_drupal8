...
CKEDITOR.plugins.add( 'powrphotofilter', {
  icons: 'photofilter',
  init: function( editor ) {
    editor.ui.addButton( 'powr_photofilter', {
      label: 'Insert POWr Photo Filter',
      command: 'insertpowrphotofilter',
      toolbar: 'insert',
      icon: 'photofilter'
    });
    editor.addCommand("insertpowrphotofilter", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'photo-filter');
      }
    });
