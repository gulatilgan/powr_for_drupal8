...
CKEDITOR.plugins.add( 'powrlocaldev', {
  icons: 'localdev',
  init: function( editor ) {
    editor.ui.addButton( 'powr_localdev', {
      label: 'Insert POWr Local Dev',
      command: 'insertpowrlocaldev',
      toolbar: 'insert',
      icon: 'localdev'
    });
    editor.addCommand("insertpowrlocaldev", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'local-dev');
      }
    });
