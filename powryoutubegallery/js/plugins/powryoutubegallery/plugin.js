...
CKEDITOR.plugins.add( 'powryoutubegallery', {
  icons: 'youtubegallery',
  init: function( editor ) {
    editor.ui.addButton( 'powr_youtubegallery', {
      label: 'Insert POWr YouTube Gallery',
      command: 'insertpowryoutubegallery',
      toolbar: 'insert',
      icon: 'youtubegallery'
    });
    editor.addCommand("insertpowryoutubegallery", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'youtube-gallery');
      }
    });
