...
CKEDITOR.plugins.add( 'powrchat', {
  icons: 'chat',
  init: function( editor ) {
    editor.ui.addButton( 'powr_chat', {
      label: 'Insert POWr Chat',
      command: 'insertpowrchat',
      toolbar: 'insert',
      icon: 'chat'
    });
    editor.addCommand("insertpowrchat", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'chat');
      }
    });
