...
CKEDITOR.plugins.add( 'powrfileembed', {
  icons: 'fileembed',
  init: function( editor ) {
    editor.ui.addButton( 'powr_fileembed', {
      label: 'Insert POWr File Embed',
      command: 'insertpowrfileembed',
      toolbar: 'insert',
      icon: 'fileembed'
    });
    editor.addCommand("insertpowrfileembed", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'file-embed');
      }
    });
