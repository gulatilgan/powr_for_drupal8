...
CKEDITOR.plugins.add( 'powrtabs', {
  icons: 'tabs',
  init: function( editor ) {
    editor.ui.addButton( 'powr_tabs', {
      label: 'Insert POWr Tabs',
      command: 'insertpowrtabs',
      toolbar: 'insert',
      icon: 'tabs'
    });
    editor.addCommand("insertpowrtabs", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'tabs');
      }
    });
