...
CKEDITOR.plugins.add( 'powrnotificationbar', {
  icons: 'notificationbar',
  init: function( editor ) {
    editor.ui.addButton( 'powr_notificationbar', {
      label: 'Insert POWr Notification Bar',
      command: 'insertpowrnotificationbar',
      toolbar: 'insert',
      icon: 'notificationbar'
    });
    editor.addCommand("insertpowrnotificationbar", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'notification-bar');
      }
    });
