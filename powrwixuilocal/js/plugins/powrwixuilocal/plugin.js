...
CKEDITOR.plugins.add( 'powrwixuilocal', {
  icons: 'wixuilocal',
  init: function( editor ) {
    editor.ui.addButton( 'powr_wixuilocal', {
      label: 'Insert POWr Wix UI Local',
      command: 'insertpowrwixuilocal',
      toolbar: 'insert',
      icon: 'wixuilocal'
    });
    editor.addCommand("insertpowrwixuilocal", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'wix-ui-local');
      }
    });
