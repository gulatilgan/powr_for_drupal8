...
CKEDITOR.plugins.add( 'powrjobboard', {
  icons: 'jobboard',
  init: function( editor ) {
    editor.ui.addButton( 'powr_jobboard', {
      label: 'Insert POWr Job Board',
      command: 'insertpowrjobboard',
      toolbar: 'insert',
      icon: 'jobboard'
    });
    editor.addCommand("insertpowrjobboard", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'job-board');
      }
    });
