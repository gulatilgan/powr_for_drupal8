...
CKEDITOR.plugins.add( 'powrweeblydemo', {
  icons: 'weeblydemo',
  init: function( editor ) {
    editor.ui.addButton( 'powr_weeblydemo', {
      label: 'Insert POWr Weebly Demo',
      command: 'insertpowrweeblydemo',
      toolbar: 'insert',
      icon: 'weeblydemo'
    });
    editor.addCommand("insertpowrweeblydemo", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'weebly-demo');
      }
    });
