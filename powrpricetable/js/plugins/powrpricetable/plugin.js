...
CKEDITOR.plugins.add( 'powrpricetable', {
  icons: 'pricetable',
  init: function( editor ) {
    editor.ui.addButton( 'powr_pricetable', {
      label: 'Insert POWr Price Table',
      command: 'insertpowrpricetable',
      toolbar: 'insert',
      icon: 'pricetable'
    });
    editor.addCommand("insertpowrpricetable", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'price-table');
      }
    });
