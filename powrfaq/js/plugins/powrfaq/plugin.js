...
CKEDITOR.plugins.add( 'powrfaq', {
  icons: 'faq',
  init: function( editor ) {
    editor.ui.addButton( 'powr_faq', {
      label: 'Insert POWr FAQ',
      command: 'insertpowrfaq',
      toolbar: 'insert',
      icon: 'faq'
    });
    editor.addCommand("insertpowrfaq", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'faq');
      }
    });
