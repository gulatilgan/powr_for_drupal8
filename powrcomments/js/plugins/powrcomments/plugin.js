...
CKEDITOR.plugins.add( 'powrcomments', {
  icons: 'comments',
  init: function( editor ) {
    editor.ui.addButton( 'powr_comments', {
      label: 'Insert POWr Comments',
      command: 'insertpowrcomments',
      toolbar: 'insert',
      icon: 'comments'
    });
    editor.addCommand("insertpowrcomments", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'comments');
      }
    });
