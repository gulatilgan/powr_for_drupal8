...
CKEDITOR.plugins.add( 'powrimageresizer', {
  icons: 'imageresizer',
  init: function( editor ) {
    editor.ui.addButton( 'powr_imageresizer', {
      label: 'Insert POWr Image Resizer',
      command: 'insertpowrimageresizer',
      toolbar: 'insert',
      icon: 'imageresizer'
    });
    editor.addCommand("insertpowrimageresizer", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'image-resizer');
      }
    });
