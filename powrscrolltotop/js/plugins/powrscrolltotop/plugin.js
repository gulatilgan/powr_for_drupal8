...
CKEDITOR.plugins.add( 'powrscrolltotop', {
  icons: 'scrolltotop',
  init: function( editor ) {
    editor.ui.addButton( 'powr_scrolltotop', {
      label: 'Insert POWr Scroll To Top',
      command: 'insertpowrscrolltotop',
      toolbar: 'insert',
      icon: 'scrolltotop'
    });
    editor.addCommand("insertpowrscrolltotop", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'scroll-to-top');
      }
    });
