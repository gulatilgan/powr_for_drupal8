...
CKEDITOR.plugins.add( 'powrplancomparison', {
  icons: 'plancomparison',
  init: function( editor ) {
    editor.ui.addButton( 'powr_plancomparison', {
      label: 'Insert POWr Plan Comparison',
      command: 'insertpowrplancomparison',
      toolbar: 'insert',
      icon: 'plancomparison'
    });
    editor.addCommand("insertpowrplancomparison", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'plan-comparison');
      }
    });
