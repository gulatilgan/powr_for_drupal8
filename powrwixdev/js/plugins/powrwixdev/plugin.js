...
CKEDITOR.plugins.add( 'powrwixdev', {
  icons: 'wixdev',
  init: function( editor ) {
    editor.ui.addButton( 'powr_wixdev', {
      label: 'Insert POWr Wix Dev',
      command: 'insertpowrwixdev',
      toolbar: 'insert',
      icon: 'wixdev'
    });
    editor.addCommand("insertpowrwixdev", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'wix-dev');
      }
    });
