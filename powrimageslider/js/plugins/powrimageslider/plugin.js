...
CKEDITOR.plugins.add( 'powrimageslider', {
  icons: 'imageslider',
  init: function( editor ) {
    editor.ui.addButton( 'powr_imageslider', {
      label: 'Insert POWr Image Slider',
      command: 'insertpowrimageslider',
      toolbar: 'insert',
      icon: 'imageslider'
    });
    editor.addCommand("insertpowrimageslider", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'image-slider');
      }
    });
