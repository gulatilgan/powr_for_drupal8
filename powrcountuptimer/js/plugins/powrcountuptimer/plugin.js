...
CKEDITOR.plugins.add( 'powrcountuptimer', {
  icons: 'countuptimer',
  init: function( editor ) {
    editor.ui.addButton( 'powr_countuptimer', {
      label: 'Insert POWr Count Up Timer',
      command: 'insertpowrcountuptimer',
      toolbar: 'insert',
      icon: 'countuptimer'
    });
    editor.addCommand("insertpowrcountuptimer", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'count-up-timer');
      }
    });
