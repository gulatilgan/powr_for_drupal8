...
CKEDITOR.plugins.add( 'powrecommerce', {
  icons: 'ecommerce',
  init: function( editor ) {
    editor.ui.addButton( 'powr_ecommerce', {
      label: 'Insert POWr Ecommerce',
      command: 'insertpowrecommerce',
      toolbar: 'insert',
      icon: 'ecommerce'
    });
    editor.addCommand("insertpowrecommerce", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'ecommerce');
      }
    });
