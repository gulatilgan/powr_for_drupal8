...
CKEDITOR.plugins.add( 'powreasypoll', {
  icons: 'easypoll',
  init: function( editor ) {
    editor.ui.addButton( 'powr_easypoll', {
      label: 'Insert POWr Easy Poll',
      command: 'insertpowreasypoll',
      toolbar: 'insert',
      icon: 'easypoll'
    });
    editor.addCommand("insertpowreasypoll", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'easy-poll');
      }
    });
