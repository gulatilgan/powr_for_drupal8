...
CKEDITOR.plugins.add( 'powrsalespop', {
  icons: 'salespop',
  init: function( editor ) {
    editor.ui.addButton( 'powr_salespop', {
      label: 'Insert POWr Sales Pop',
      command: 'insertpowrsalespop',
      toolbar: 'insert',
      icon: 'salespop'
    });
    editor.addCommand("insertpowrsalespop", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'sales-pop');
      }
    });
