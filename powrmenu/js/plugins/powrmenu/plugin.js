...
CKEDITOR.plugins.add( 'powrmenu', {
  icons: 'menu',
  init: function( editor ) {
    editor.ui.addButton( 'powr_menu', {
      label: 'Insert POWr Menu',
      command: 'insertpowrmenu',
      toolbar: 'insert',
      icon: 'menu'
    });
    editor.addCommand("insertpowrmenu", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'menu');
      }
    });
