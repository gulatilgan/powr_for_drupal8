...
CKEDITOR.plugins.add( 'powreventslider', {
  icons: 'eventslider',
  init: function( editor ) {
    editor.ui.addButton( 'powr_eventslider', {
      label: 'Insert POWr Event Slider',
      command: 'insertpowreventslider',
      toolbar: 'insert',
      icon: 'eventslider'
    });
    editor.addCommand("insertpowreventslider", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'event-slider');
      }
    });
