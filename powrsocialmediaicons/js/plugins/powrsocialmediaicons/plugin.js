...
CKEDITOR.plugins.add( 'powrsocialmediaicons', {
  icons: 'socialmediaicons',
  init: function( editor ) {
    editor.ui.addButton( 'powr_socialmediaicons', {
      label: 'Insert POWr Social Media Icons',
      command: 'insertpowrsocialmediaicons',
      toolbar: 'insert',
      icon: 'socialmediaicons'
    });
    editor.addCommand("insertpowrsocialmediaicons", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'social-media-icons');
      }
    });
