...
CKEDITOR.plugins.add( 'powrmultislider', {
  icons: 'multislider',
  init: function( editor ) {
    editor.ui.addButton( 'powr_multislider', {
      label: 'Insert POWr Multi Slider',
      command: 'insertpowrmultislider',
      toolbar: 'insert',
      icon: 'multislider'
    });
    editor.addCommand("insertpowrmultislider", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'multi-slider');
      }
    });
