...
CKEDITOR.plugins.add( 'powrflickrgallery', {
  icons: 'flickrgallery',
  init: function( editor ) {
    editor.ui.addButton( 'powr_flickrgallery', {
      label: 'Insert POWr Flickr Gallery',
      command: 'insertpowrflickrgallery',
      toolbar: 'insert',
      icon: 'flickrgallery'
    });
    editor.addCommand("insertpowrflickrgallery", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'flickr-gallery');
      }
    });
