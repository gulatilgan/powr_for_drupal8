...
CKEDITOR.plugins.add( 'powrvimeogallery', {
  icons: 'vimeogallery',
  init: function( editor ) {
    editor.ui.addButton( 'powr_vimeogallery', {
      label: 'Insert POWr Vimeo Gallery',
      command: 'insertpowrvimeogallery',
      toolbar: 'insert',
      icon: 'vimeogallery'
    });
    editor.addCommand("insertpowrvimeogallery", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'vimeo-gallery');
      }
    });
