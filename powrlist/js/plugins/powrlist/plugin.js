...
CKEDITOR.plugins.add( 'powrlist', {
  icons: 'list',
  init: function( editor ) {
    editor.ui.addButton( 'powr_list', {
      label: 'Insert POWr List',
      command: 'insertpowrlist',
      toolbar: 'insert',
      icon: 'list'
    });
    editor.addCommand("insertpowrlist", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'list');
      }
    });
