...
CKEDITOR.plugins.add( 'powrstagingdev', {
  icons: 'stagingdev',
  init: function( editor ) {
    editor.ui.addButton( 'powr_stagingdev', {
      label: 'Insert POWr Staging Dev',
      command: 'insertpowrstagingdev',
      toolbar: 'insert',
      icon: 'stagingdev'
    });
    editor.addCommand("insertpowrstagingdev", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'staging-dev');
      }
    });
