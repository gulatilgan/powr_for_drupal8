...
CKEDITOR.plugins.add( 'powreventgallery', {
  icons: 'eventgallery',
  init: function( editor ) {
    editor.ui.addButton( 'powr_eventgallery', {
      label: 'Insert POWr Event Gallery',
      command: 'insertpowreventgallery',
      toolbar: 'insert',
      icon: 'eventgallery'
    });
    editor.addCommand("insertpowreventgallery", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'event-gallery');
      }
    });
