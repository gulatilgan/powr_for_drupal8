...
CKEDITOR.plugins.add( 'powrdigitaldownload', {
  icons: 'digitaldownload',
  init: function( editor ) {
    editor.ui.addButton( 'powr_digitaldownload', {
      label: 'Insert POWr Digital Download',
      command: 'insertpowrdigitaldownload',
      toolbar: 'insert',
      icon: 'digitaldownload'
    });
    editor.addCommand("insertpowrdigitaldownload", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'digital-download');
      }
    });
