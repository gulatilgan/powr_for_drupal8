...
CKEDITOR.plugins.add( 'powrweather', {
  icons: 'weather',
  init: function( editor ) {
    editor.ui.addButton( 'powr_weather', {
      label: 'Insert POWr Weather',
      command: 'insertpowrweather',
      toolbar: 'insert',
      icon: 'weather'
    });
    editor.addCommand("insertpowrweather", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'weather');
      }
    });
