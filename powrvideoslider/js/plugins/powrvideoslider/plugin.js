...
CKEDITOR.plugins.add( 'powrvideoslider', {
  icons: 'videoslider',
  init: function( editor ) {
    editor.ui.addButton( 'powr_videoslider', {
      label: 'Insert POWr Video Slider',
      command: 'insertpowrvideoslider',
      toolbar: 'insert',
      icon: 'videoslider'
    });
    editor.addCommand("insertpowrvideoslider", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'video-slider');
      }
    });
