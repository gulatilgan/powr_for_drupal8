...
CKEDITOR.plugins.add( 'powrpaypalbutton', {
  icons: 'paypalbutton',
  init: function( editor ) {
    editor.ui.addButton( 'powr_paypalbutton', {
      label: 'Insert POWr PayPal Button',
      command: 'insertpowrpaypalbutton',
      toolbar: 'insert',
      icon: 'paypalbutton'
    });
    editor.addCommand("insertpowrpaypalbutton", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'paypal-button');
      }
    });
